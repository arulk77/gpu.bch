...
__constant__ UINT cs_bch_min_poly[2*T] = {0x1b,0x1b,0x6b1,0x1b,0x993,0x6b1,0x74f,0x1b};

// This constant is the galois field window
__constant__ UINT cs_gf_wind = 1<<M-1 ;

__constant__ UINT cs_prim_poly[16] = {0x0,0x1,0x3,0xb,0x13,0x25,0x43,0x89,0x11d,0x211,0x409,0x805,0x1053,0x201d,0x4443,0x8003};


/*+++++++++++++++ Global variables for cuda  ++++++++++++++++++++++++*/
__device__ UINT gb_gf_ext[1<<M];
__device__ UINT gb_gf_log_table[1<<M];
